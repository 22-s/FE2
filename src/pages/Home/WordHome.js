      ...
      <ScrollView>
        ...
        <View style={styles.categoryArea}>
          <CategoryBox
            ...
            subtitle="회계/재무"
            icon={<Accounting />}
            onPress={() => handlePress({category:"회계재무", title:"정확한 회계 처리", subtitle:"회계/재무"})}
          />
          <CategoryBox
            title="IT 프로젝트 관리"
            subtitle="기술/IT"
            icon={<IT />}
            onPress={() => handlePress({category:"기술IT", title:"IT 프로젝트 관리", subtitle:"기술/IT"})}
          />
        </View>
        <View style={styles.categoryArea}>
          <CategoryBox
            ...
            subtitle="마케팅/세일즈"
            icon={<Marketing />}
            onPress={() => handlePress({category:"마케팅세일즈", title:"효과적인 고객 유치", subtitle:"마케팅/세일즈"})}
          />
          <CategoryBox
            title="인사 관리를 위한"
            subtitle="HR/조직"
            icon={<HR />}
            onPress={() => handlePress({category:"HR조직", title:"인사 관리를 위한", subtitle:"HR/조직"})}
          />
        </View>
        <View style={styles.categoryArea}>
          <CategoryBox
            ...
            subtitle="리더십/팀워크"
            icon={<Captain />}
            onPress={() => handlePress({category:"리더십팀워크", title:"리더의 소통 방법", subtitle:"리더십/팀워크"})}
          />
          <CategoryBox
            title="효과적인 협상 전략"
            subtitle="협상/의사결정"
            icon={<Negotiate />}
            onPress={() => handlePress({category:"협상의사결정", title:"효과적인 협상 전략", subtitle:"협상/의사결정"})}
          />
        </View>
      </ScrollView>
    </View>
